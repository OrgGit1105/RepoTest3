...
//         if($request->user_name != "regex:/(\w{2,}@\w{2,}\.\w{2,8})|(^(0)[0-9]{9,12}$)/") {
//             return $this->responseJsonError(Response::HTTP_EMAIL_INVALIDATE, "Email không đúng định dang");
//         }
//         if($request->password < 8) {
//             return $this->responseJsonError(Response::CODE_PASSWORD_FALSE, "Mật khẩu phải ít nhất 8 ký tự");
//         }
        return $this->responseJsonError(Response::HTTP_UNAUTHORIZED, "Eメールまたはパスワードが正しくありません。");
    }
