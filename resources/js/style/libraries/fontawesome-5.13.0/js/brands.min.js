...
!(function(){
  ...
  } catch (c){} var l = (c.navigator || {}).userAgent, h = void 0 === l ? '' : l, v = c, m = z, a = (v.document, !!m.documentElement && !!m.head && typeof m.addEventListener === 'function' && m.createElement, ~h.indexOf('MSIE') || h.indexOf('Trident/'), '___FONT_AWESOME___'), M = (function(){
    try {
      return !0;
    } catch (c){
      return !1;
    }
  }()); var s = v || {}; s[a] || (s[a] = {}), s[a].styles || (s[a].styles = {}), s[a].hooks || (s[a].hooks = {}), s[a].shims || (s[a].shims = []); var H = s[a]; function f(c, h){
    var z = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks, l = void 0 !== z && z, v = Object.keys(h).reduce(function(c, z){
      var l = h[z]; return l.icon ? c[l.iconName] = l.icon : c[z] = l, c;
    }, {}); typeof H.hooks.addPack !== 'function' || l ? H.styles[c] = (function(v){
