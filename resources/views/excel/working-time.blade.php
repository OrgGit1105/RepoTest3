<table>
    <thead>
        <tr>
            ...
            <th style="font-size: 14px;text-align: center;height: 30px;font-weight: 500;">Remark</th>
    ...
    <tbody>
        @foreach($data as $value)
            <tr>
                <td style="width: 150px; color: red; text-align: center;">{{$value['warning']}}</td>
                <td style="width: 100px; color: red; text-align: center;">{{$value['late']}}</td>
